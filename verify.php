<?php
    ...
    if($match > 0){
        ...
        echo '<script type="text/javascript">';
        echo 'setTimeout(function () { Swal.fire("Oops...","The url is either invalid or you have already activated your account.","error");';
        echo '}, 500);</script>';
    }
}                 
else{
    // Invalid approach
    echo '<script type="text/javascript">';
    echo 'setTimeout(function () { Swal.fire("Oops...", "Invalid approach please use the link that has been sent to your email.","error");';
    echo '}, 500);</script>';
}
?>
